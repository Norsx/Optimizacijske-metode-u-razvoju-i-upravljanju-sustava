...
međusobno množe. Postupak \emph{konveksifikacije} \cite[str.~28]{jokic_ljapunov}
uklanja tu bilinearnost: množenjem \eqref{eq:z4lmi} slijeva i zdesna s
$Q = P^{-1} \succ 0$ i uvođenjem $Y = KQ$ dobiva se
\begin{equation}
