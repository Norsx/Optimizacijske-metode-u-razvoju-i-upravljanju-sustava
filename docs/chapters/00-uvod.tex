...
Svi numerički rezultati dobiveni su u MATLAB-u; skripte se nalaze u direktoriju
\texttt{src/} repozitorija, po jedna za svaki zadatak, i reproduciraju sve
brojeve i slike iz ovog rada.
